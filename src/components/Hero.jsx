  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        <div className="absolute flex flex-col py-8 md:min-width-[760px] bottom-[-25%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl">
          <p>Data Services</p>
          <div className="flex justify-between flex-wrap px-5">
            <p className="flex px-5 py-2 text-slate-500">
